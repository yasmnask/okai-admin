        ...
        <div className="bg-white dark:bg-[#1a1d1a] p-10 rounded-[3rem] shadow-sm border border-slate-100 dark:border-slate-800/50 transition-colors">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 bg-slate-50 dark:bg-[#2a2d2a] dark:text-white border-none rounded-2xl text-sm font-bold outline-none focus:ring-2 focus:ring-orange-500/20 transition-colors"
                  />
                </div>
              </div>
              ...
              {/* PASSWORD (OPTIONAL) */}
              <div className="space-y-2">
                <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1 flex justify-between transition-colors">
            ...
            <div className="p-6 bg-slate-50 dark:bg-slate-800/50 rounded-3xl border border-slate-100 dark:border-slate-700 flex gap-4 items-start mt-6 transition-colors">
              <div className="p-2 bg-white dark:bg-[#2a2d2a] rounded-xl text-slate-500 dark:text-slate-400 shadow-sm transition-colors">
                <Info size={20} />
              </div>
              <div>
                <p className="text-xs font-black text-slate-700 dark:text-slate-300 uppercase tracking-tight mb-1 transition-colors">
                  Informasi Pembaruan
                </p>
                <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed font-medium transition-colors">
