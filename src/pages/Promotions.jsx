...
export default function Promotions() {
  ...
  const promoStats = [
    { label: 'Total Kupon', value: '24', icon: <Ticket size={20} />, color: 'text-blue-600', bg: 'bg-blue-50' },
    { label: 'Kupon Aktif', value: '18', icon: <CheckCircle2 size={20} />, color: 'text-green-600', bg: 'bg-green-50' },
    { label: 'Total Pemakaian', value: '1,204', icon: <MousePointer2 size={20} />, color: 'text-purple-600', bg: 'bg-purple-50' },
    { label: 'Akan Berakhir', value: '3', icon: <Clock size={20} />, color: 'text-orange-600', bg: 'bg-orange-50' },
  ];
  ...
  return (
    <div className="p-8 bg-[#F8FAFC] min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-10">
        <div>
          <h1 className="text-2xl font-black text-[#1E293B]">Promotion <span className="text-[#E65100]">Center</span></h1>
          <p className="text-slate-400 text-sm font-medium italic">Kelola kode voucher dan kampanye diskon OKAI</p>
        </div>
              ...
              <tr key={promo.id} className="hover:bg-orange-50/20 transition-colors group">
                ...
                <td className="p-6">
                  <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest ${
                    promo.status === 'Active' ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'
                  }`}>
                    {promo.status}
                  </span>
                </td>
