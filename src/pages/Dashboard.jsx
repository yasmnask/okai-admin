...
export default function Dashboard() {
  ...
  return (
    <div className="p-8 h-screen bg-white dark:bg-[#1a1e1a] overflow-auto">
      {/* HEADER */}
      <header className="flex justify-between items-center mb-10">
        <div>
          ...
          <p className="text-slate-400 dark:text-[#e1d4cc] text-sm font-medium italic uppercase tracking-wider">
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="p-2.5 bg-white dark:bg-[#3e3c3a] border border-slate-100 dark:border-0 dark:shadow-black dark:shadow-sm rounded-xl text-slate-400 dark:text-slate-200 hover:text-[#E65100] transition-all"
          >
          ...
          >
            ...
            <div className="text-left hidden sm:block">
              <p className="text-[10px] font-black text-slate-400 dark:text-slate-200 uppercase tracking-widest leading-none mb-1">
                Administrator
              </p>
              <p className="text-sm font-bold text-slate-700 dark:text-[#e1d4cc] leading-none">
                {user.name}
              </p>
            </div>
          </button>
        ...
        {stats.map((stat, i) => (
          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="text-green-500 dark:text-green-50 text-xs font-bold bg-green-50 dark:bg-green-500 px-2 py-1 rounded-lg flex items-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* CHART AREA */}
        <div className="lg:col-span-2 bg-white dark:bg-[#1a1d1a] p-8 rounded-[2.5rem] border border-slate-100 dark:border-0 dark:shadow-black dark:shadow-2xl shadow-sm">
          <div className="flex justify-between items-center mb-8">
            <h3 className="font-black text-lg text-slate-800 dark:text-slate-200 tracking-tight">
              Sales Analytics
            </h3>
            <div className="flex gap-2">
              <button className="px-3 py-1 text-xs font-bold bg-orange-50 dark:bg-[#E65100] text-[#E65100] dark:text-orange-50 rounded-lg">
                Monthly
              </button>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-[#1a1d1a] p-8 rounded-[2.5rem] border border-slate-100 dark:border-0 dark:shadow-black dark:shadow-2xl shadow-sm">
          ...
          <button className="w-full mt-6 py-3 bg-slate-50 dark:bg-[#e65100] text-slate-400 dark:text-slate-50 text-xs font-black uppercase tracking-widest rounded-xl hover:bg-orange-50 dark:hover:bg-[#1a1e1a]   hover:text-[#E65100] transition-all">
            View All Logs
          </button>
        </div>
      </div>
