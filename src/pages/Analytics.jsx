    ...
    <div className="p-8 bg-[#F8FAFC] dark:bg-[#1a1e1a] min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-10">
        ...
        <div className="flex gap-3">
          <button className="flex items-center gap-2 bg-white dark:bg-[#3e3c3a] border border-slate-100 text-slate-600 dark:text-slate-300 px-5 py-3 rounded-2xl font-bold shadow-sm hover:bg-slate-50 dark:hover:bg-[#1a1e1a] dark:hover:scale-105 dark:border-0 transition-all">
            <Calendar size={18} /> Last 30 Days
          </button>
          <button className="flex items-center gap-2 bg-[#E65100] text-white px-5 py-3 rounded-2xl font-bold shadow-lg shadow-orange-100 dark:shadow-black hover:scale-105 transition-transform">
        ...
        {[
          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <span
                className={`text-[10px] font-black px-2 py-1 rounded-lg ${stat.up ? "bg-green-50 dark:bg-green-600 text-green-600 dark:text-green-50" : "bg-red-50 dark:bg-red-600 text-red-600 dark:text-red-50"}`}
              >
                {stat.trend}
              </span>
            </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 mb-8">
        {/* REVENUE CHART */}
        <div className="xl:col-span-2 bg-white dark:bg-[#1a1d1a] p-8 rounded-[2.5rem] border border-slate-100 dark:border-0 dark:shadow-black dark:shadow-xl shadow-sm">
        ...
        <div className="bg-white dark:bg-[#1a1d1a] p-8 rounded-[2.5rem] border border-slate-100 dark:border-0 dark:shadow-black dark:shadow-xl shadow-sm">
          <h3 className="font-black text-slate-800 dark:text-slate-200 text-lg mb-8">
            Sales by Category
          </h3>
      ...
      <div className="bg-white dark:bg-[#1a1d1a] p-8 rounded-[2.5rem] border border-slate-100 dark:border-0 dark:shadow-black dark:shadow-xl shadow-sm">
        <h3 className="font-black text-slate-800 dark:text-slate-200 text-lg mb-8 tracking-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={i}
              className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-[#3e3c3a] border border-slate-100 dark:border-orange-200 group hover:border-orange-200 dark:hover:border-slate-200 transition-all"
            >
              ...
              <div className="flex-1">
                ...
                <div className="flex justify-between items-center mt-1">
                  ...
                  <span className="text-[10px] font-black text-green-600 dark:text-green-300">
                    {prod.growth}
                  </span>
                </div>
              </div>
