  ...
  const [affiliates] = useState([
    {
      ...
      code: "OKAI-DHAN01",
      referrals: 124,
      totalSales: "Rp 45.200.000",
      commission: "Rp 4.520.000",
      status: "Active",
    },
    {
      id: 2,
      ...
      code: "OKAI-ANDI99",
      referrals: 56,
      totalSales: "Rp 12.800.000",
      commission: "Rp 1.280.000",
      status: "Pending",
    },
    {
      id: 3,
      ...
      code: "OKAI-YASM22",
      referrals: 89,
      totalSales: "Rp 28.450.000",
      commission: "Rp 2.845.000",
      status: "Active",
    },
  ]);
      ...
      <div className="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden mb-8">
        <div className="p-6 border-b border-slate-50 flex items-center justify-between bg-orange-50/10">
          <h3 className="font-black text-slate-800 text-lg flex items-center gap-2">
            <Clock className="text-[#E65100]" size={20} /> Permintaan Pencairan
            Komisi
          </h3>
          <span className="px-3 py-1 bg-white border border-orange-100 text-[#E65100] text-[10px] font-black rounded-lg uppercase tracking-widest">
            {pendingWithdrawals.length} Memerlukan Tindakan
          </span>
        </div>
          ...
          <tbody className="divide-y divide-slate-50">
            {pendingWithdrawals.map((req) => (
              ...
              >
                ...
                <td className="p-6 font-black text-[#E65100] text-sm">
                  {req.amount}
                </td>
                ...
                <td className="p-6 text-center">
                  <div className="flex justify-center gap-2">
                    <button className="px-4 py-2 bg-green-500 text-white text-[10px] font-black uppercase rounded-xl hover:brightness-110 shadow-md shadow-green-100">
                      Approve
                    </button>
                    <button className="px-4 py-2 bg-slate-100 text-slate-400 text-[10px] font-black uppercase rounded-xl hover:bg-red-50 hover:text-red-500 transition-all">
                      Reject
                    </button>
                  </div>
                </td>
